...
public class TalismaneClient {
	...
	public CoNLL_Structure analyse(String text) throws UnknownHostException,
			IOException, InterruptedException {
		return this.analyse(text, true);
	}

	public CoNLL_Structure analyse(String text, boolean print)
		...
		CoNLL_Structure conll_structure = new CoNLL_Structure();
		int id_sentence = 0;
		String line = "";
		...
		// TODO check threads on large corpora
		/* sort sentences */
		Collections.sort(conll_structure, new Comparator<CoNLL_Sentence>() {
			@Override
			public int compare(CoNLL_Sentence o1, CoNLL_Sentence o2) {
